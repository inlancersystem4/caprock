...
export default {
    ...
    computed: {
        btnDisabled() {
            return !this.userName.trim() || !this.userEmail.trim() || !this.userNumber.trim() || this.userNumber.trim().length !== 10 || !this.isvalidEmail;
        }
    },
    methods: {
        validateEmail() {
        ...
        async UserData() {
            ...
            try {
                const response = await fetchWrapper.post(`${baseUrl}/users-list`, user_data);
            ...
            <div class="col-8">
                ...
                <div class="address-form">
                    ...
                    <div class="space-y-8px">
                        ...
                        <Input placeholder="Enter User Name" id="User Name" :value="userName"
                            @input="event => userName = event.target.value" />
                        <ErrorMessage msg="" v-if="!userName && formSubmitted" />
                    </div>
